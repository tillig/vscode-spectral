 ...
 * @returns A FileSystemWatcher that monitors the provided path.
 */
 ...
 */
function sendFileChangeNotification(uri: string, type: FileChangeType) {
 ...
 * @param context - Information about the extension runtime that can be used during activation.
 */
